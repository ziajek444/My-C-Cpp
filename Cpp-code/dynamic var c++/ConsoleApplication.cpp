...
public:
	void *pointer;
	int8_t type; // 0 undefined, 1 char, 2 short, 3 int, 4 float, 5 double, 6 string, 7 object
	//explicit
	explicit DYNAMIC()
	{
	...
	DYNAMIC(DYNAMIC &a) {
		...
		case 1:
			...
			*((char*)pointer) = *((char*)a.pointer);
			break;
		case 2:
			this->pointer = new short;
			*((short*)pointer) = *((short*)a.pointer);
			break;
		case 3:
			this->pointer = new int;
			*((int*)pointer) = *((int*)a.pointer);
			break;
		case 4:
			this->pointer = new float;
			*((float*)pointer) = *((float*)a.pointer);
			break;
		case 5:
			this->pointer = new double;
			*((double*)pointer) = *((double*)a.pointer);
			break;
		case 6:
			this->pointer = new string;
			*((string*)pointer) = *((string*)a.pointer);
			break;
		default:
			break;
		}
	...
	//DYNAMIC(DYNAMIC &&a) {
	//	cout << "dynamic start (DYNAMIC && (by cast))" << endl;
	//	this->type = a.type;
	//	this->pointer = a.pointer;
	//	//*((int *)this->pointer) = 999;
	//}
	...
	// CHAR
	DYNAMIC& operator=(char& arg1) //for auto variable
	{
		MakeMem();
		this->type = 1;
		pointer = new char;
	...
	// SHORT
	DYNAMIC& operator=(short& arg1) //for auto variable
	{
		MakeMem();
		this->type = 2;
		pointer = new short;
	...
	// INT
	DYNAMIC& operator=(int& arg1) //for auto variable
	{
		MakeMem();
		this->type = 3;
		pointer = new int;
	...
	// FLOAT
	DYNAMIC& operator=(float& arg1) //for auto variable
	{
		MakeMem();
		this->type = 4;
		pointer = new float;
	...
	// DOUBLE
	DYNAMIC& operator=(double& arg1) //for auto variable
	{
		MakeMem();
		this->type = 5;
		pointer = new double;
	...
	// STRING
	DYNAMIC& operator=(string& arg1) //for auto variable
	{
		MakeMem();
		this->type = 6;
		pointer = new string;
	...
	void MakeMem()
	{
		...
		case 6:
			...
			break;
		case 7:
			delete pointer; //i have no idea how to delete template obj
		default:
			break;
		}
	}
